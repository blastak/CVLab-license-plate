...
class VinOCR_Onnx(OnnxBase):
    def __init__(self, model_path, classes_path):
        super().__init__(model_path, classes_path, conf_thresh=0.3, iou_thresh=0.3, in_w=inpWidth, in_h=inpHeight)
...
if __name__ == '__main__':
    r_net = load_model_VinOCR_Onnx('../VIN_OCR/weight')
    ...
    if use_detector:
        ...
        jpg_path = random.choice(jpg_paths)  # 테스트를 위해 하나만 선택
